...
import { useRouter } from 'expo-router'; // <-- Importación moderna de Expo Router

import BrandHeader from '../components/BrandHeader'; // <-- Ruta corregida
import { colors } from '../theme/colors'; // <-- Ruta corregida (asumiendo que theme está en src/theme)
...
export default function LoginScreen() {
  ...
  // Navega al grupo de pestañas reemplazando la pantalla actual
  const goToMain = () => router.replace('/(tabs)/mapa');
        ...
        >
          ...
          <Text style={styles.registerText}>
            ...
            <Text 
              ...
              onPress={() => router.push('/register')} // <-- Redirección correcta a la pantalla de registro
            >
              Regístrate aquí
            </Text>
          </Text>
