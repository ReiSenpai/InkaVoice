      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({
              pathname: '/audioguia',
              params: { nombre: content.title, region: content.region },
            })}
          >
          ...
          <TouchableOpacity style={styles.secondaryButton} onPress={() => setShowLangModal(true)}>
            ...
            <View style={styles.langIndicator}>
              <Text style={styles.langIndicatorText}>{language.toUpperCase()}</Text>
            </View>
          </TouchableOpacity>
                ...
                <View style={styles.langOptionLeft}>
                  ...
                  <View>
                    ...
                    <Text style={styles.langNative}>
                      {lang === 'Español' ? 'Español' : lang === 'English' ? 'English' : 'Runasimi'}
                    </Text>
                  </View>
                </View>
                {language === lang && (
