...
export default function HistoryScreen() {
  ...
  activeRouteTitle: { fontSize: 20, fontWeight: '800', color: colors.textOnDark, marginBottom: 12 },
  activeRouteLink: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  activeRouteLinkText: { color: colors.textOnDark, fontSize: 12, fontWeight: '600' },
  ...
  favoriteTitle: { color: colors.textOnDark, fontSize: 14, fontWeight: '700' },
  ...
  timelineStatusText: { color: colors.textOnDark, fontSize: 11, fontWeight: '700' },
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={styles.activeRouteLink}>
            <Ionicons name="map-outline" size={14} color={colors.textOnDark} />
